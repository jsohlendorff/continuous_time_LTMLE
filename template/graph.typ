...
#let timegrid2(new_method: true, slides: false) = {
    cetz.canvas(length: 1cm, {
        ...
        let grid1 = (5,8.8,12.8)
        let grid2 = (2,3.4, 4.6,5.6)
        
        if new_method == false {
            rect((0,1.5), (5.6,-1.5),fill:aqua,stroke:none)
            ...
            group({time_grid((0,-1),(20,-1), grid1,anchor: "south")})
            group({time_grid((0,1),(20,1), grid2,anchor: "south")})
        } else {
            rect((0,1.5), (3.4,0.3),fill:aqua,stroke:none)
            rect((0,-1.7), (8.8,-0.5),fill:aqua,stroke:none)
