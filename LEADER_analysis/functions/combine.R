...
combine <- function(comed, adv, reg, out, outcomes = c("all_cause_mortality", "mace", "censored"), treat_names = c("lira", "placebo"), id_regimen) {
  ...
  fix_duplicates(dt, treat_names) # Fix duplicates in the data
}