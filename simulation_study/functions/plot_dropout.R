...
## Version: 
## Last-Updated: Jun 25 2025 (11:39) 
...
plot_dropout <- function(n = 10000, values, max_fup = 900) {
    ...
    for (i in 1:nrow(values)) {
        ...
        data_continuous <- simulate_simple_continuous_time_data(n = 10000, uncensored = TRUE,
                                                                effects = vary_effect(
                                                                    effect_A_on_Y,
                                                                    effect_L_on_Y,
                                                                    effect_L_on_A
        ...
        not_drop_out <- data.table(id = ids_not_drop_out, time = 900, 
